...
public class Proveedores extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel19.setText("ID_Proveedor");

        jLabel21.setForeground(new java.awt.Color(255, 255, 255));
        jLabel21.setText("Nombre");

        jLabel22.setForeground(new java.awt.Color(255, 255, 255));
        jLabel22.setText("Cod_Pos");
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addComponent(txtProveedor, javax.swing.GroupLayout.PREFERRED_SIZE, 214, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void btnAgregar3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAgregar3ActionPerformed
        try {
            PreparedStatement pst = cx.prepareStatement("INSERT INTO proveedores (id_proveedor, nombre, cod_pos, calle, numero) VALUES (?, ?, ?, ?, ?)");
            pst.setString(1, txtProveedor.getText());
            pst.setString(2, txtNombre.getText());
            pst.setString(3, txtCodPos.getText());
    ...
    private void btnActualizar3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnActualizar3ActionPerformed
        try{
            PreparedStatement up = cx.prepareStatement("UPDATE proveedores SET id_proveedor='"+txtProveedor.getText()+"', nombre='"+txtNombre.getText()+
                "', cod_pos='"+txtCodPos.getText()+"', calle='"+txtCalle.getText()+"', numero='"+txtNumero.getText()+"' WHERE id_proveedor='"+txtProveedor.getText()+"'");
            up.executeUpdate();
        }catch(SQLException e){
            JOptionPane.showMessageDialog(null,e.getMessage());
        }
    ...
    private void ActualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ActualizarActionPerformed
        int fila = Resultado.getSelectedRow();
            if (fila>=0){
                    txtProveedor.setText(Resultado.getValueAt(fila,0).toString());
                    txtNombre.setText(Resultado.getValueAt(fila,1).toString());
                    txtCodPos.setText(Resultado.getValueAt(fila,2).toString());
                    txtCalle.setText(Resultado.getValueAt(fila,3).toString());
                    txtNumero.setText(Resultado.getValueAt(fila,4).toString());
            }else{
    ...
    private void EliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_EliminarActionPerformed
        ...
        try{
          PreparedStatement del = cx.prepareStatement("DELETE FROM proveedores WHERE id_proveedor='"+id+"'");
          del.executeUpdate();
        } catch(SQLException e) {
            JOptionPane.showMessageDialog(null,e.getMessage());
        }
